...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("LoveMarks");
#else
        glview = cocos2d::GLViewImpl::createWithRect("LoveMarks", Rect(0,0,640,960));
#endif
        director->setOpenGLView(glview);
	}
#if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32)
	auto searchPaths = FileUtils::getInstance()->getSearchPaths();
	searchPaths.insert(searchPaths.begin(), "E:/Cocos2d/full/3.7.1/projects/LoveMarks/");
